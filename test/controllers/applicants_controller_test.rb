...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference("Applicant.count") do
      post applicants_url, params: { applicant: { first_name: @applicant.first_name, last_name: @applicant.last_name } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { first_name: @applicant.first_name, last_name: @applicant.last_name } }
