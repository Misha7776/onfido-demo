class ApplicantsController < ApplicationController
  ...
  def create
    @response = Applicants::Operations::Create.call(record_params: applicant_params.to_unsafe_h)
    binding.pry
    @applicant = @response.data.fetch(:record)
  ...
  private
    ...
    def applicant_params
      params.require(:applicant).permit(:first_name, :last_name, :document, :document_type)
    end
end
